    ...
    if(walletAddress) {
      ...
      <form>
        ...
        <Button
              type="submit"
              variant="contained"
              sx={{ mt: 2, mb: 2 }} style={{backgroundColor:"#5D5DFF", color:"white"}} onClick={mintNFT}> Mint NFT</Button></>
    }
  }

  return (
    <div styles={{backgroundColor:'#25282C'}}>
      <Head>
      ...
      <Box sx={{flexDirection: 'row', justifyContent:'center', alignItems:'center', backgroundColor:'#25282C'}}>
      ...
      <Card sx={{maxWidth:600,maxHeight:600, mt:2, mb:4, flexDirection:'col'}} position="fixed" styles={{Color:"black"}}>
      <main className={styles.main}> 
        <h1 styles={{fontFamily:"sans-serif"}}> NFT Credit using Gasless Wallet</h1>
        {renderForm()}
        {renderAlert()}
